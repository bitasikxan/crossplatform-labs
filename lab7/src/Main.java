...
public class Main extends JFrame implements ActionListener {
    ...
    private boolean checkWin(int r, int c, int player) {
        return countConsecutive(r, c, player, 0, 1) >= WIN_CONDITION ||  // --
                countConsecutive(r, c, player, 1, 0) >= WIN_CONDITION || // |
                countConsecutive(r, c, player, 1, 1) >= WIN_CONDITION || // \
                countConsecutive(r, c, player, 1, -1) >= WIN_CONDITION;  // /
    }
