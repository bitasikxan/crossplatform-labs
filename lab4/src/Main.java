...
public class Main extends JFrame {
    ...
    private JPanel createMenuView() {
        ...
        gbc.gridx = 0;
        gbc.gridy = 2;
        JLabel modeLabel = new JLabel("Рівень інтелекту:");
    ...
    private void showStatistics() {
        ...
        String msg = String.format("Глобальна статистика:\n\n Перемог: %d\n Поразок: %d\n Нічиїх: %d", wins, losses, ties);
    ...
    enum Result {
        WIN("Перемога!", new Color(40, 167, 69)),
        LOSE("Поразка!", new Color(220, 53, 69)),
        TIE("Нічия! Переграємо раунд.", new Color(232, 169, 81));
